...
Сейчас ты видишь приветственное сообщение от нашей команды, но после <a href="/register" data-link class="postcard__text-link">регистрации</a> у тебя будет своя собственная персональная страничка и лента в таком же виде, но уже наполненная интересными лично тебе.
...
Как будешь готов - можем переходить к <a href="/register" data-link class="postcard__text-link">регистрации</a>. Обещаем, что это не займет много времени!

А возможно, у тебя уже есть персональная страничка на нашем сайте? :) Тогда мы можем перейти сразу к <a href="/login" data-link class="postcard__text-link">авторизации</a>. Это будет еще быстрее.
