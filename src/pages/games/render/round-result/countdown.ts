...
import { getRoundResultTimelineStartMs } from "../../round/timeline";
...
export function renderRoundResultCountdown(
  ...
  const startAtMs = options.startAtMs ?? getRoundResultTimelineStartMs(question);
  ...
  return `
    ...
    >
      <div class="games-question-countdown__line" data-games-round-question-position>
